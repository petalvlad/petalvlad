...
This is an iOS App helps users to learn foreign languages by performing scenes and recording their dialogues and actions on video. Imagine that you have a script with several roles and lines. You can create a performance for a specific scene, choose a role, wait for other participants and start the action. Performing keeps going turn by turn via sending recorded on the video dialogues.

My work on the first stage of this project was to build a prototype that provides messaging feature, creating (recording), browsing and playback of video messages. 
